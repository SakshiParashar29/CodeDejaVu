...
const memes = [
  ...
  "Why cry in love when you can cry in front of your IDE?",
   "I tried to be normal once. Got a runtime error.",
   "I don’t always test my code, but when Ido, I ignore the results.",
    "My brain has too many tabs open and all of them are buffering.",
    "We were compatible… until version updates broke everything.",
    "Someone said I'm emotionally unavailable… I think I forgot to initialize myself.",
    "My productivity is O(n²) where n = number of distractions.",
    "I study best the night before exams… like a true emergency system."
];
